...
| `affinity                                                    | Default node affinity for pod assignment for all services                                                                                                                                                                                                                                                                                                           | `{}`                                                                       |
...
| `authenticate.affinity                                       | Node affinity for pod assignment for authenticate service. If empty .Values.affinity is used                                                                                                                                                                                                                                                                        | `{}`                                                                       |
...
| `proxy.affinity                                              | Node affinity for pod assignment for proxy service. If empty .Values.affinity is used                                                                                                                                                                                                                                                                               | `{}`                                                                       |
...
| `authorize.affinity                                          | Node affinity for pod assignment for authorize service. If empty .Values.affinity is used                                                                                                                                                                                                                                                                           | `{}`                                                                       |
...
| `databroker.affinity                                         | Node affinity for pod assignment for databroker service. If empty .Values.affinity is used                                                                                                                                                                                                                                                                          | `{}`                                                                       |
...
| `ingressContoller.affinity                                   | Node affinity for pod assignment for ingressController service. If empty .Values.affinity is used                                                                                                                                                                                                                                                                   | `{}`                                                                       |
