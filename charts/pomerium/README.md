...
| `authorize.existingSigningKeySecret`                         | Name of existing Signing key Secret for proxy requests.                                                                                                                                                                                                                                            |                                                                             |
| `authorize.signingKey`                                       | Signing key is the base64 encoded key used to sign outbound requests.                                                                                                                                                                                                                              |                                                                             |
